...
/**
 * Provides synchronous access to GoogleCloudStorage.
 * <p/>
 *
 * @see GoogleCloudStorageAsyncApi
 ...
 */
@Beta
public interface GoogleCloudStorageApi {

   /**
    * Provides synchronous access to Bucket features
    *
    */
   @Delegate
   @Path("/")
